...
export default (env: ConfigEnv) => {
  return [
    ...
    Components({
      ...
      // imports Specify the location of the component, the default is src/components; you can also add the view directory if necessary
      dirs: ['src/components/'],
    ...
    Markdown({
      ...
      markdownItSetup(md) {
        // https://prismjs.com/
        md.use(Prism);
        // Set to new page jump for all links in md
